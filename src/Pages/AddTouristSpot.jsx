...
const AddTouristSpot = () => {
    ...
    const handleAddSpot = e => {
       ...
       const addSpot = {spotName, countryName, shortDescription, location, averageCost, travelTime, visitors, userName, photo, email, seasonality}
    ...
    return (
        ...
        <form onSubmit={handleAddSpot}>
          ...
          <input type="submit" value="Add Spot" className="btn btn-block bg-green-500" />
        </form>
      </div>
